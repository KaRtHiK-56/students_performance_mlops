...
from setup.tools import (
    find_packages,
    setup,
)  # it is used to find all packages n libraries listed in modules
...
def get_requirements(file_path: str) -> List[str]:
    ...
    with open(file_path) as file_obj:
        ...
        ):  # to remove -e. in the requirements.txt file , this will enable to install all locally created python module/package libraries (triggering setup.py)
